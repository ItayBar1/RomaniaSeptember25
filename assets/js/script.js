...
const itineraryData = [
    {
        ...
        plan: [
            ...
            { time: 'בוקר', icon: '🏨', description: 'נסיעה למלון והתארגנות.' },
            {
                time: 'אחר הצהריים',
                icon: '🏛️',
                description: 'סיור רגלי בעיר העתיקה (Centrul Vechi) ובאזור ארמון הפרלמנט.',
            },
        ...
        plan: [
            {
                time: 'בוקר',
                icon: '🧗',
                description: 'נסיעה קצרה ליער שליד בראשוב וטיול רגלי בקניון 7 הסולמות (Canionul Șapte Scări).',
            },
            {
                time: 'צהריים',
                icon: '🚶‍♂️',
                description:
                    'חזרה לבראשוב וסיור במרכז העיר העתיקה, הכולל את הכיכר המרכזית, הכנסייה השחורה והרחוב הצר ביותר.',
            },
    ...
    },
    {
        ...
        plan: [
            { time: 'בוקר', icon: '🧛', description: 'נסיעה קצרה לטירת בראן (Bran Castle) וסיור במקום.' },
            {
                time: 'צהריים',
                icon: '🚗',
                description: 'נסיעה ארוכה לכיוון אזור קניון ביקאז (Cheile Bicazului) והאגם האדום.',
            },
        ...
        plan: [
            {
                ...
                icon: '⛰️',
                description:
                    "נסיעה קצרה מאזור ביקאז לפארק הלאומי מאסיף צ'אחלאו. טיפוס לפסגת טואקה (Toaca Peak) דרך גרם המדרגות המפורסם.",
            },
        ...
        plan: [
            {
                time: 'בוקר',
                icon: '🕍',
                description: "סיור רגלי במרכז העיר של קלוז', כולל כיכר אונירי והמבנים הגותיים.",
            },
